const ownerNumber = ["557598205795@s.whatsapp.net","558899267668@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '557598205795' 
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Guga;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=557598205795:+55 75 9820-5795\n' 
+ 'END:VCARD'
